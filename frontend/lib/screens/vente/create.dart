...
import 'package:stock_master/dialogs/stock_movement/quantity.dart';
...
class _CreateSellState extends State<CreateSell> {
    ...
    try {
      ...
      if (e.response!.statusCode == 417) {
        _showProductQuantityDialog(
            context, product!.quantityInStock.toString());
  ...
  Future<void> _showProductQuantityDialog(
      BuildContext context, String quantity) async {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return QuantityStock(quantity: quantity);
      },
    );
  }
}
